...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    document.getElementById('notarizeForm').addEventListener('submit', handleNotarize);
});
...
async function handleNotarize(event) {
    ...
    document.getElementById('processingMessage').textContent = 'Computing document hash...';
    ...
    try {
        ...
        await sendTransactionToBlockchain(docHash, file.name);
...
async function sendTransactionToBlockchain(docHash, filename) {
    try {
        ...
        // Estimate gas
        const gasEstimate = await contract.methods.storeHash(hashBytes)
        ...
        // Show success
        showResult('success', 'Document Notarized Successfully!', 
